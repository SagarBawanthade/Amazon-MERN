        ...
        <header>
          <Navbar bg="dark" variant="dark" expand="lg">
            <Container>
              ...
              <LinkContainer to="/">
                <Navbar.Brand to="/">amazeShop</Navbar.Brand>
              </LinkContainer>
              <Navbar.Toggle arias-controls="basic-navbar-nav" />
                ...
                <Nav className="me-auto w-100 justify-content-end">
                  ...
                  {userInfo ? (
                    <NavDropdown title={userInfo.name} id="basic-nav-dropdown">
                      ...
                      <NavDropdown.Divider />
                      <NavLink className="dropdown-item" style={{ backgroundColor: "#f8ba00", color: "black" }}
                        to="#signout"
